...
struct OBSStudioAPI : obs_frontend_callbacks {
	...
	void *obs_frontend_add_control_window(void *icon, void *name,
					      void *page) override
	{
		return (void *)main->AddControlPage(
			(QIcon *)icon, (QString *)name, (QWidget *)page);
	}
	void *obs_frontend_add_input_control(void *name, void *page) override
	{
		return (void *)main->AddInputControl((QString *)name,
						     (QWidget *)page);
	}
	void *obs_frontend_add_output_control(void *name, void *page) override
	{
		return (void *)main->AddOutputControl((QString *)name,
						      (QWidget *)page);
	}
