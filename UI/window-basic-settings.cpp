...
#define ENCODER_STR(str) QTStr("Basic.Settings.Output.Simple.Encoder." str)
	...
	ui->simpleOutRecEncoder->addItem(ENCODER_STR("Software.X264"), QString(SIMPLE_ENCODER_X264));
	ui->simpleOutRecEncoder->addItem(ENCODER_STR("SoftwareLowCPU.X264"), QString(SIMPLE_ENCODER_X264_LOWCPU));
