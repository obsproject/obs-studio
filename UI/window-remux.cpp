...
int RemuxQueueModel::rowCount(const QModelIndex &parent) const
{
	Q_UNUSED(parent);
...
int RemuxQueueModel::columnCount(const QModelIndex &parent) const
{
	Q_UNUSED(parent);
...
void OBSRemux::rowCountChanged(const QModelIndex &parent, int first, int last)
{
	Q_UNUSED(parent);
	Q_UNUSED(first);
	Q_UNUSED(last);
