...
struct obs_frontend_callbacks {
	...
	virtual void *obs_frontend_get_mapper(void) = 0;
	...
	virtual void *obs_frontend_add_input_control(void *name,
						     void *page) = 0;
	virtual void *obs_frontend_add_output_control(void *name,
						      void *page) = 0;
	virtual void
