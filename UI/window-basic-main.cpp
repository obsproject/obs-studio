...
void OBSBasic::CreateSourcePopupMenu(QListWidgetItem *item, bool preview)
{
	...
	popup.addAction(ui->actionPasteSource);
	popup.addSeparator();
...
void OBSBasic::on_actionCopySource_triggered()
{
	...
	ui->actionPasteSource->setEnabled(true);
}

void OBSBasic::on_actionPasteSource_triggered()
{
	OBSBasicSourceSelect *select =
			reinterpret_cast<OBSBasicSourceSelect*>(sender());

	select->SourcePaste(copyString, (const bool)copyVisible);
...
void OBSBasic::on_actionPasteFilters_triggered()
{
	...
	copy_paste_filters(dstSource, source);
}
