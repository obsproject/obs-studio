...
public:
	...
	QMenu *CreateDeinterlacingMenu(OBSSource source);
	QMenu *CreateScaleFilteringMenu(OBSSceneItem item);
	QMenu *CreateBlendingMethodMenu(OBSSceneItem item);
	QMenu *CreateBlendingModeMenu(OBSSceneItem item);
	QMenu *CreateBackgroundColorMenu(OBSSceneItem item);
