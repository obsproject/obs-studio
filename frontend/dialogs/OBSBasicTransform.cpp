...
void OBSBasicTransform::setSceneWeak(OBSWeakSource weak)
{
...
void OBSBasicTransform::attachMediator(OBS::CanvasMediator *mediator)
{
	...
	if (this->mediator) {
		disconnect(this->mediator, &OBS::CanvasMediator::previewChanged, this,
			   &OBSBasicTransform::setSceneWeak);
	}
	...
	connect(mediator, &OBS::CanvasMediator::previewChanged, this, &OBSBasicTransform::setSceneWeak);
