...
//
//OBSLogUploadDialog::OBSLogUploadDialog(QWidget *parent, const QString &url, const bool crash)
//	: QDialog(parent),
//	  ui(new Ui::OBSLogUploadDialog)
//{
//	setWindowFlags(windowFlags() & ~Qt::WindowContextHelpButtonHint);
//	ui->setupUi(this);
//
//	ui->stackedWidget->setCurrentIndex(0);
//
//	connect(ui->confirmUploadButton, &QPushButton::clicked, this, &OBSLogUploadDialog::startLogUpload);
//
//
//
...
//}
//
//void OBSLogUploadDialog::startLogUpload()
//{
//
//}
//
//
//void OBSLogUploadDialog::on_copyURL_clicked()
//{
//	QClipboard *clipboard = QApplication::clipboard();
//	clipboard->setText(ui->urlEdit->text());
//}
//
//void OBSLogUploadDialog::on_analyzeURL_clicked()
//{
//	QUrlQuery param;
