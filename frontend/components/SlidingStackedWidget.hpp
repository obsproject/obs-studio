...
public:
	enum class Direction { Invalid, LeftToRight, RightToLeft, TopToBottom, BottomToTop, Automatic };
	...
	void advanceToIndex(int idx, Direction direction = Direction::Automatic);
	void advanceToWidget(QWidget *widget, Direction direction = Direction::Automatic);
