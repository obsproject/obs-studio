...
bool AutoConfigStreamPage::validatePage()
{
	...
	if (autoConfig->service != AutoConfig::Service::Twitch && autoConfig->service != AutoConfig::Service::YouTube &&
...
void AutoConfigStreamPage::ServiceChanged()
{
	...
	if ((service == "Twitch" && autoConfig->twitchAuto) || (service == "Amazon IVS" && autoConfig->amazonIVSAuto))
		regionBased = false;
