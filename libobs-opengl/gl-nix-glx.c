...
gl_nix_glx_windowinfo_create(const struct gs_init_data *info)
{
	UNUSED_PARAMETER(info);
	return bmalloc(sizeof(struct gl_windowinfo));
}

static void gl_nix_glx_windowinfo_destroy(struct gl_windowinfo *info)
{
	bfree(info);
}
...
static struct gl_platform *gl_nix_glx_platform_create(gs_device_t *device,
						      uint32_t adapter)
{
...
static void gl_nix_glx_platform_destroy(struct gl_platform *plat)
{
...
static bool gl_nix_glx_platform_init_swapchain(struct gs_swap_chain *swap)
{
...
static void gl_nix_glx_platform_cleanup_swapchain(struct gs_swap_chain *swap)
{
	UNUSED_PARAMETER(swap);
	/* Really nothing to clean up? */
}

static void gl_nix_glx_device_enter_context(gs_device_t *device)
{
...
static void gl_nix_glx_device_leave_context(gs_device_t *device)
{
	Display *display = device->plat->display;
...
static void *gl_nix_glx_device_get_device_obj(gs_device_t *device)
{
	return device->plat->context;
}

static void gl_nix_glx_getclientsize(const struct gs_swap_chain *swap,
...
static void gl_nix_glx_clear_context(gs_device_t *device)
{
	Display *display = device->plat->display;
...
static void gl_nix_glx_update(gs_device_t *device)
{
	Display *display = device->plat->display;
...
static void gl_nix_glx_device_load_swapchain(gs_device_t *device,
					     gs_swapchain_t *swap)
{
...
static void gl_nix_glx_device_present(gs_device_t *device)
{
...
static const struct gl_winsys_vtable glx_winsys_vtable = {
	.windowinfo_create = gl_nix_glx_windowinfo_create,
	.windowinfo_destroy = gl_nix_glx_windowinfo_destroy,
	.platform_create = gl_nix_glx_platform_create,
	.platform_destroy = gl_nix_glx_platform_destroy,
	.platform_init_swapchain = gl_nix_glx_platform_init_swapchain,
	.platform_cleanup_swapchain = gl_nix_glx_platform_cleanup_swapchain,
	.device_enter_context = gl_nix_glx_device_enter_context,
	.device_leave_context = gl_nix_glx_device_leave_context,
	.device_get_device_obj = gl_nix_glx_device_get_device_obj,
	.getclientsize = gl_nix_glx_getclientsize,
	.clear_context = gl_nix_glx_clear_context,
	.update = gl_nix_glx_update,
	.device_load_swapchain = gl_nix_glx_device_load_swapchain,
	.device_present = gl_nix_glx_device_present,
};

const struct gl_winsys_vtable *gl_nix_glx_get_winsys_vtable(void)
{
