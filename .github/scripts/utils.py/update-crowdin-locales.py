...
def main() -> int:
    ...
    parser.add_argument("updated_locales", type=str, help="Array of updated locales")
    ...
    updated_locales_str = arguments.updated_locales
    updated_locales_str = updated_locales_str.replace("[", "[\"")
    updated_locales_str = updated_locales_str.replace(",", "\",\"")
    updated_locales_str = updated_locales_str.replace("]", "\"]")

    try:
        updated_locales = json.loads(updated_locales_str)
