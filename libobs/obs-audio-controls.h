...
EXPORT void obs_fader_add_callback(
		obs_fader_t *fader, obs_fader_changed_t callback, void *param);
EXPORT void obs_fader_remove_callback(
		obs_fader_t *fader, obs_fader_changed_t callback, void *param);
 ...
 * signal.
 */
EXPORT bool obs_volmeter_attach_source(
		obs_volmeter_t *volmeter, obs_source_t *source);
 ...
 * circumstances.
 */
EXPORT void obs_volmeter_set_update_interval(
		obs_volmeter_t *volmeter, const unsigned int ms);
