...
uint32_t obs_encoder_get_skip_samples(const obs_encoder_t *encoder)
{
	if (encoder->info.get_skip_samples) {
		return encoder->info.get_skip_samples(encoder->context.data);
	}
