...
static obs_source_t *obs_load_source_type(obs_data_t *source_data)
{
	...
	obs_data_set_default_bool(source_data, "hide_mixer", false);
	obs_source_set_mixer_hidden(source,
			obs_data_get_bool(source_data, "hide_mixer"));
...
obs_data_t *obs_save_source(obs_source_t *source)
{
	...
	bool       hide_mixer  = obs_source_mixer_hidden(source);
	...
	obs_data_set_bool  (source_data, "hide_mixer", hide_mixer);
