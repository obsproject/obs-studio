...
#define OBS_OUTPUT_OPTIONAL_VIDEO (1 << 6)
#define OBS_OUTPUT_OPTIONAL_AUDIO (1 << 7)
#define OBS_OUTPUT_OPTIONAL_AV \
	(OBS_OUTPUT_OPTIONAL_VIDEO | OBS_OUTPUT_OPTIONAL_AUDIO)
