...
extern struct obs_core_audio_mix *obs_create_audio_mix(struct audio_output_info *ai);
...
extern bool obs_canvas_reset_audio_internal(obs_canvas_t *canvas, struct audio_output_info *ai);
