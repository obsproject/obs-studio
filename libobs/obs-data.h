...
EXPORT obs_data_t *obs_data_create_from_json_file_safe(
		const char *json_file, const char *backup_ext);
...
/* Set functions */
EXPORT void obs_data_set_string(
		obs_data_t *data, const char *name, const char *val);
...
EXPORT void obs_data_set_array(
		obs_data_t *data, const char *name, obs_data_array_t *array);

/*
 * Default value functions.
 */
EXPORT void obs_data_set_default_string(
		obs_data_t *data, const char *name, const char *val);
EXPORT void obs_data_set_default_int(
		obs_data_t *data, const char *name, long long val);
EXPORT void obs_data_set_default_double(
		obs_data_t *data, const char *name, double val);
EXPORT void obs_data_set_default_bool(obs_data_t *data, const char *name, bool val);
EXPORT void obs_data_set_default_obj(
		obs_data_t *data, const char *name, obs_data_t *obj);
 ...
 */
EXPORT void obs_data_set_autoselect_string(
		obs_data_t *data, const char *name, const char *val);
EXPORT void obs_data_set_autoselect_int(
		obs_data_t *data, const char *name, long long val);
EXPORT void obs_data_set_autoselect_double(
		obs_data_t *data, const char *name, double val);
EXPORT void obs_data_set_autoselect_bool(
		obs_data_t *data, const char *name, bool val);
EXPORT void obs_data_set_autoselect_obj(
		obs_data_t *data, const char *name, obs_data_t *obj);
...
EXPORT obs_data_array_t *obs_data_get_default_array(
		obs_data_t *data, const char *name);

EXPORT const char *obs_data_get_autoselect_string(
		obs_data_t *data, const char *name);
...
EXPORT obs_data_array_t *obs_data_get_autoselect_array(
		obs_data_t *data, const char *name);
...
EXPORT void   obs_data_array_insert(
		  obs_data_array_t *array, size_t idx, obs_data_t *obj);
EXPORT void obs_data_array_push_back_array(
		obs_data_array_t *array, obs_data_array_t *array2);
...
EXPORT void obs_data_item_set_default_string(
		obs_data_item_t **item, const char *val);
...
EXPORT void obs_data_item_set_default_array(
		obs_data_item_t **item, obs_data_array_t *val);

EXPORT void obs_data_item_set_autoselect_string(
		obs_data_item_t **item, const char *val);
...
EXPORT void obs_data_item_set_autoselect_obj(
		obs_data_item_t **item, obs_data_t *val);
EXPORT void obs_data_item_set_autoselect_array(
		obs_data_item_t **item, obs_data_array_t *val);
...
EXPORT void obs_data_set_vec2(
		obs_data_t *data, const char *name, const struct vec2 *val);
EXPORT void obs_data_set_vec3(
		obs_data_t *data, const char *name, const struct vec3 *val);
EXPORT void obs_data_set_vec4(
		obs_data_t *data, const char *name, const struct vec4 *val);
EXPORT void obs_data_set_quat(
		obs_data_t *data, const char *name, const struct quat *val);

EXPORT void obs_data_set_default_vec2(
		obs_data_t *data, const char *name, const struct vec2 *val);
EXPORT void obs_data_set_default_vec3(
		obs_data_t *data, const char *name, const struct vec3 *val);
EXPORT void obs_data_set_default_vec4(
		obs_data_t *data, const char *name, const struct vec4 *val);
EXPORT void obs_data_set_default_quat(
		obs_data_t *data, const char *name, const struct quat *val);

EXPORT void obs_data_set_autoselect_vec2(
		obs_data_t *data, const char *name, const struct vec2 *val);
EXPORT void obs_data_set_autoselect_vec3(
		obs_data_t *data, const char *name, const struct vec3 *val);
EXPORT void obs_data_set_autoselect_vec4(
		obs_data_t *data, const char *name, const struct vec4 *val);
EXPORT void obs_data_set_autoselect_quat(
		obs_data_t *data, const char *name, const struct quat *val);
...
EXPORT void obs_data_get_default_vec2(
		obs_data_t *data, const char *name, struct vec2 *val);
EXPORT void obs_data_get_default_vec3(
		obs_data_t *data, const char *name, struct vec3 *val);
EXPORT void obs_data_get_default_vec4(
		obs_data_t *data, const char *name, struct vec4 *val);
EXPORT void obs_data_get_default_quat(
		obs_data_t *data, const char *name, struct quat *val);

EXPORT void obs_data_get_autoselect_vec2(
		obs_data_t *data, const char *name, struct vec2 *val);
EXPORT void obs_data_get_autoselect_vec3(
		obs_data_t *data, const char *name, struct vec3 *val);
EXPORT void obs_data_get_autoselect_vec4(
		obs_data_t *data, const char *name, struct vec4 *val);
EXPORT void obs_data_get_autoselect_quat(
		obs_data_t *data, const char *name, struct quat *val);
