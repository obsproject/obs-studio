...
/* This is an internal OBS macro to keep internals working for a small amount of time.
   Do not set it yourself! The _autoselect_ APIs are all deprecated, and will be treated as such. This means the
   deprecation grace period starts now, not when this macro is removed. You have been warned. */
#ifndef OBS_DATA_TOLERATE_AUTOSELECT
#define AUTOSELECT_DEPRECATED OBS_DEPRECATED
#else
#define AUTOSELECT_DEPRECATED
#endif
 ...
 */
AUTOSELECT_DEPRECATED EXPORT void obs_data_set_autoselect_string(obs_data_t *data, const char *name, const char *val);
AUTOSELECT_DEPRECATED EXPORT void obs_data_set_autoselect_int(obs_data_t *data, const char *name, long long val);
...
AUTOSELECT_DEPRECATED EXPORT void obs_data_set_autoselect_obj(obs_data_t *data, const char *name, obs_data_t *obj);
...
AUTOSELECT_DEPRECATED EXPORT const char *obs_data_get_autoselect_string(obs_data_t *data, const char *name);
AUTOSELECT_DEPRECATED EXPORT long long obs_data_get_autoselect_int(obs_data_t *data, const char *name);
AUTOSELECT_DEPRECATED EXPORT double obs_data_get_autoselect_double(obs_data_t *data, const char *name);
AUTOSELECT_DEPRECATED EXPORT bool obs_data_get_autoselect_bool(obs_data_t *data, const char *name);
AUTOSELECT_DEPRECATED EXPORT obs_data_t *obs_data_get_autoselect_obj(obs_data_t *data, const char *name);
...
AUTOSELECT_DEPRECATED EXPORT bool obs_data_has_autoselect_value(obs_data_t *data, const char *name);
...
AUTOSELECT_DEPRECATED EXPORT bool obs_data_item_has_autoselect_value(obs_data_item_t *data);
...
AUTOSELECT_DEPRECATED EXPORT void obs_data_unset_autoselect_value(obs_data_t *data, const char *name);
...
AUTOSELECT_DEPRECATED EXPORT void obs_data_item_unset_autoselect_value(obs_data_item_t *data);
...
AUTOSELECT_DEPRECATED EXPORT const char *obs_data_item_get_autoselect_string(obs_data_item_t *item);
AUTOSELECT_DEPRECATED EXPORT long long obs_data_item_get_autoselect_int(obs_data_item_t *item);
AUTOSELECT_DEPRECATED EXPORT double obs_data_item_get_autoselect_double(obs_data_item_t *item);
AUTOSELECT_DEPRECATED EXPORT bool obs_data_item_get_autoselect_bool(obs_data_item_t *item);
AUTOSELECT_DEPRECATED EXPORT obs_data_t *obs_data_item_get_autoselect_obj(obs_data_item_t *item);
AUTOSELECT_DEPRECATED EXPORT obs_data_array_t *obs_data_item_get_autoselect_array(obs_data_item_t *item);
...
EXPORT bool obs_data_item_get_default_frames_per_second(obs_data_item_t *item, struct media_frames_per_second *fps,
							const char **option);
AUTOSELECT_DEPRECATED EXPORT bool obs_data_item_get_autoselect_frames_per_second(obs_data_item_t *item,
										 struct media_frames_per_second *fps,
										 const char **option);
