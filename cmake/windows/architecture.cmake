...
cmake_path(GET CMAKE_CURRENT_BINARY_DIR PARENT_PATH OBS_BUILD_PARENT_PATH)

if(OBS_PARENT_ARCHITECTURE STREQUAL CMAKE_VS_PLATFORM_NAME)
  if(OBS_PARENT_ARCHITECTURE STREQUAL ARM64)
    execute_process(
      COMMAND
        "${CMAKE_COMMAND}" -S ${CMAKE_CURRENT_SOURCE_DIR} -B ${OBS_BUILD_PARENT_PATH}/build_x64 -A
    ...
    execute_process(
      COMMAND
        "${CMAKE_COMMAND}" -S ${CMAKE_CURRENT_SOURCE_DIR} -B ${OBS_BUILD_PARENT_PATH}/build_x86 -A
