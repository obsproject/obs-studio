...
function(check_sdk_requirements)
  ...
  if(XCODE_VERSION VERSION_LESS _obs_macos_minimum_xcode)
    message(
      FATAL_ERROR
      "Your Xcode version (${XCODE_VERSION}) is too low. Xcode ${_obs_macos_minimum_xcode} is required to build OBS."
    )
  endif()
endfunction()
