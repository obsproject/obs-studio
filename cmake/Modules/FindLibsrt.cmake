...
find_path(
  ...
  HINTS ENV LIBSRT_PATH ${LIBSRT_PATH} ${CMAKE_SOURCE_DIR}/${LIBSRT_PATH} ${_LIBSRT_INCLUDE_DIRS}
        ${DepsPath}
...
find_library(
  ...
  HINTS ENV LIBSRT_PATH ${LIBSRT_PATH} ${CMAKE_SOURCE_DIR}/${LIBSRT_PATH} ${_LIBSRT_LIBRARY_DIRS}
        ${DepsPath}
...
if(LIBSRT_FOUND)
  ...
  if(NOT TARGET Libsrt::Libsrt)
    ...
    set_target_properties(Libsrt::Libsrt PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                                    "${LIBSRT_INCLUDE_DIRS}")
  endif()
else()
