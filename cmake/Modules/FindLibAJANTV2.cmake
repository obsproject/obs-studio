...
if(LIBAJANTV2_FOUND)
  ...
  if(OS_WINDOWS)
    set(AJA_LIBRARIES_INCLUDE_DIRS
        ${AJA_LIBRARIES_INCLUDE_DIRS} ${AJA_LIBRARIES_INCLUDE_DIR}/ajantv2/src
  ...
  if(NOT TARGET AJA::LibAJANTV2)
    if(IS_ABSOLUTE "${LIBAJANTV2_LIBRARIES}")
      ...
      if(DEFINED LIBAJANTV2_DEBUG_LIBRARIES)
        add_library(AJA::LibAJANTV2_Debug INTERFACE IMPORTED)
        set_target_properties(
          AJA::LibAJANTV2_Debug PROPERTIES IMPORTED_LOCATION
      ...
      if(DEFINED LIBAJANTV2_DEBUG_LIBRARIES)
        add_library(AJA::LibAJANTV2_Debug INTERFACE IMPORTED)
        set_target_properties(
          AJA::LibAJANTV2_Debug PROPERTIES IMPORTED_LIBNAME
                                           "${LIBAJANTV2_DEBUG_LIBRARIES}")
      endif()
    endif()
    ...
    target_compile_definitions(
      AJA::LibAJANTV2
      INTERFACE
        "$<$<BOOL:${OS_WINDOWS}>:AJA_WINDOWS;_WINDOWS;WIN32;MSWindows;_NDEBUG>"
        "$<$<BOOL:${OS_MACOS}>:AJAMac;AJA_MAC>"
        "$<$<BOOL:${OS_LINUX}>:AJA_LINUX;AJALinux>")

    if(DEFINED LIBAJANTV2_DEBUG_LIBRARIES)
      set_target_properties(
        AJA::LibAJANTV2_Debug PROPERTIES INTERFACE_INCLUDE_DIRECTORIES
                                         "${LIBAJANTV2_INCLUDE_DIRS}")

      target_compile_definitions(
        AJA::LibAJANTV2_Debug
        INTERFACE
          "$<$<BOOL:${OS_WINDOWS}>:AJA_WINDOWS;_WINDOWS;WIN32;MSWindows;_DEBUG>"
          "$<$<BOOL:${OS_MACOS}>:AJAMac;AJA_MAC>"
          "$<$<BOOL:${OS_LINUX}>:AJA_LINUX;AJALinux>")
    endif()
