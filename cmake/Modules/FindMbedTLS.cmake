...
find_library(
  ...
  HINTS ENV MBEDCRYPTO_PATH ${MBEDCRYPTO_PATH} ${CMAKE_SOURCE_DIR}/${MBEDCRYPTO_PATH}
...
# Sometimes mbedtls is split between three libs, and sometimes it isn't. If it isn't, let's check if
# the symbols we need are all in MBEDTLS_LIB.
if(MBEDTLS_LIB
...
if(MBEDTLS_LIB
  ...
  # Otherwise, if we find MBEDTLS_LIB, and it has both CRYPTO and x509 within the single lib (i.e. a
  # windows build environment), then also feel free to go ahead.
elseif(
  MBEDTLS_LIB
