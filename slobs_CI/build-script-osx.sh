...
cp -R "../build/rundir/${BUILDCONFIG}/bin/obs64 Helper.app" "./Frameworks/obs64 Helper.app"
cp -R "../build/rundir/${BUILDCONFIG}/bin/obs64 Helper (GPU).app" "./Frameworks/obs64 Helper (GPU).app"
cp -R "../build/rundir/${BUILDCONFIG}/bin/obs64 Helper (Plugin).app" "./Frameworks/obs64 Helper (Plugin).app"
cp -R "../build/rundir/${BUILDCONFIG}/bin/obs64 Helper (Renderer).app" "./Frameworks/obs64 Helper (Renderer).app"
