...
class MetalBuffer {
    ...
    /// Gets an opaque pointer for the ``MetalBuffer`` instance and increase its reference count by one
...
final class MetalVertexBuffer: MetalBuffer {
    ...
    ///
    /// > Note: The color data needs to be converted from the packed UInt32 format used by `libobs` into a normalzed
