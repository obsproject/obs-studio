Aerium Contribution Guidelines
============

Aerium accepts contributions via public **pull requests** to https://github.com/AeriumChris/Aerium. Include a description of the change, its motivation, how it was tested, and any AI assistance used.

Aerium is an independent, early-stage fork of OBS Studio. The engineering guidelines below are inherited from OBS and apply to work in this fork where relevant. References to OBS's maintainers, review labels, and external services describe upstream processes, not services operated by Aerium. The AI policy at the end of this document is specific to Aerium.

Changes intended for the OBS Project must separately comply with its [current contribution guidelines](https://github.com/obsproject/obs-studio/blob/master/CONTRIBUTING.md), including its restrictions on AI-generated submissions. Aerium's acceptance of a contribution does not imply upstream acceptance.
...
Aerium permits AI-assisted code, documentation, and investigation, including work supported by GitHub Copilot. This policy applies only to Aerium, not to upstream OBS Studio.

Contributors must:

* Disclose material AI assistance in the pull request, including the tools used and which parts they helped produce.
* Understand and review the submitted changes. Check assumptions against the actual codebase and relevant documentation; plausible generated output is not evidence of correctness.
* Run checks appropriate to the change and describe the results. Explicitly identify anything not tested, including unavailable operating systems or hardware.
* Keep changes focused and explain their behavior, risks, and limitations. Add regression coverage for changed behavior where practical.
* Verify that contributed material can be distributed under the applicable project licenses. Preserve attribution and do not submit copied material whose origin or licensing cannot be established.
* Keep credentials, private user data, recordings, and confidential material out of prompts, logs, commits, and public reports.

Maintainers remain responsible for accepting changes and deciding whether the review and validation are sufficient. Automated checks and AI review do not replace human accountability. Contributions may be rejected when their author cannot explain or validate them.
