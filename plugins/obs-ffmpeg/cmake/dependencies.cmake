...
if((OS_WINDOWS AND CMAKE_VS_PLATFORM_NAME STREQUAL x64) OR OS_LINUX)
  if(ENABLE_AMF)
    find_package(AMF 1.4.29 QUIET)

    if(AMF_FOUND)
      add_subdirectory(obs-amf-test)
    else()
      message(STATUS "AMF not found - AMF encoder will be disabled")
    endif()
  endif()
