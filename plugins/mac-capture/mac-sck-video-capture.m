...
API_AVAILABLE(macos(12.5)) static bool init_screen_stream(struct screen_capture *sc)
{
    ...
    bool foundOutputFPS = obs_get_video_info(&video_info);
    ...
    if (foundOutputFPS) {
        ...
        CMTime updateTimePadding = CMTimeMultiplyByFloat64(frameTimeInterval, 0.1);
        CMTime minimumUpdateTime = CMTimeSubtract(frameTimeInterval, updateTimePadding);
