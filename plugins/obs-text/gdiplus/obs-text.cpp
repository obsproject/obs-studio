...
#define S_FILE                          "file"
#define S_REFRESH_TIME                  "refresh_time"
#define S_TEXT                          "text"
...
#define T_REFRESH_TIME                  T_("RefreshTime")
...
inline void TextSource::Update(obs_data_t *s)
{
	...
	float new_refresh_time = (float)obs_data_get_double(s, S_REFRESH_TIME);
...
inline void TextSource::Tick(float seconds)
{
	...
	if (update_time_elapsed >= refresh_time) {
			     ...
			     obs_data_t *s)
{
	...
	set_vis(use_file, S_REFRESH_TIME, true);
	return true;
}
...
static obs_properties_t *get_properties(void *data)
{
	...
	obs_properties_add_float(props, S_REFRESH_TIME, T_REFRESH_TIME, 0.0,
				 10.0, 0.5);
...
static void defaults(obs_data_t *settings, int ver)
{
	...
	obs_data_set_default_double(settings, S_REFRESH_TIME, 1.0f);
