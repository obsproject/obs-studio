...
enum Codec { QCOM_H264, QCOM_H265, QCOM_AV1 };
...
void QpRange(Codec codec, double bppf, uint32_t *minQp, uint32_t *maxQp);
double ComputeBppf(double bitrate_bps, uint32_t width, uint32_t height, double fps);
} // namespace MF
