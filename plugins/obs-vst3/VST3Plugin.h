...
public:
	...
	struct Vst3AudioData *filterData = nullptr;
	...
	bool loadStates(const std::vector<uint8_t> &comp, const std::vector<uint8_t> &ctrl) const;
	...
	std::vector<BusInfo> inputAudioBusInfos;
	std::vector<BusInfo> outputAudioBusInfos;
