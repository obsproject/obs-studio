...
struct VST3ClassInfo {
	...
	bool discardable =
		false; // Optional but requested to us by Steinberg: the classes need to be reloaded from the module at each host startup and can not be cached (ex: Waves plugins).
};
