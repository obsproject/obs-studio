/******************************************************************************
    ...
    This file is part of win-asio. It adapts to C the IASIO COM interface.
...
#define ASIO_GetBufferSize(dev, min, max, pref, gran)     (dev)->asio->lpVtbl->getBufferSize((dev)->asio, (min), (max),\
(pref), (gran))
...
#define ASIO_CreateBuffers(dev, infos, n, size, cb) (dev)->asio->lpVtbl->createBuffers((dev)->asio, (infos), (n), \
(size), (cb))
