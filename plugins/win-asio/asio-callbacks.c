...
/* ASIO callbacks are quite a pain because they don't store the 'this' pointer of the COM driver. In c++ we could do
 * some template tricks as done by JUCE. But in C, we're more restricted, hence the use of these macros.
 * The number of callback sets is the number of supported devices. So up to 16, which is plenty enough !
 */
