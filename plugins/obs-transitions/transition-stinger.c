...
static void *stinger_create(obs_data_t *settings, obs_source_t *source)
{
	...
	proc_handler_add(ph, "void transition_audio_update()",
			 stinger_audio_update, s);
...
static void stinger_defaults(obs_data_t *settings)
{
	...
	obs_data_set_default_int(settings, "audio_monitoring",
				 (long long)OBS_MONITORING_TYPE_NONE);
